 ...
 */
#include "marker_detection/helper.cpp"
#include "detector/DetectorFactory.cpp"

#include <ros/ros.h>
#include <opencv2/opencv.hpp>
#include <dynamic_reconfigure/server.h>
#include <marker_detection/MarkerDetectionConfig.h>
...
private:
    ...
    // Dynamic reconfigure
    dynamic_reconfigure::Server<marker_detection::MarkerDetectionConfig> reconf_server;
    dynamic_reconfigure::Server<marker_detection::MarkerDetectionConfig>::CallbackType f;
...
public:
    ...
    void publishPose(Eigen::Vector3f position, Eigen::Quaternionf orientation, geometry_msgs::Pose optiPose) {
        ...
        Eigen::Matrix3f R_MA_CB = R_markercam * orientation.toRotationMatrix();
    ...
    /**
      ...
      */
    void reconfigure(marker_detection::MarkerDetectionConfig &config, uint32_t level) {
        delay       = config.delay;
