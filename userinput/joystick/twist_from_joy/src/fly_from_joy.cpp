...
public:
  Teleop()
  {
    ...
    // Init subscribers
    joy_subscriber_ = params.subscribe<sensor_msgs::Joy>("joy", 1, boost::bind(&Teleop::joyCallback, this, _1));
    velocity_publisher_ = params.advertise<geometry_msgs::Twist>("cmd_vel_joy", 1);
    land_publisher_ = params.advertise<std_msgs::Empty>("land", 1);
    takeoff_publisher_ = params.advertise<std_msgs::Empty>("takeoff", 1);
    reset_publisher_ = params.advertise<std_msgs::Empty>("reset",1);
  }
